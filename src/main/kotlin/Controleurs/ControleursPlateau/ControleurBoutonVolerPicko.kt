...
class ControleurBoutonVolerPicko(plateau: Plateau, plateau2j: Plateau2j, plateau3j: Plateau3j, plateau4j: Plateau4j, mainVue: MainVue, jeux: Jeux) :
    ...
    override fun handle(event: ActionEvent) {
        ...
        //ENlève la saturation des pickominos lors d'un prochain tour.
        for (i in 0 until 16) {
        ...
        if (plateau.totDes >= 21) {
            if (plateau.totDes in jeux.etatDuJeux().pickosStackTops()) {
            ...
            jeux.prendreLeDomino(Domino(plateau.totDes))
            plateau2j.pilePickoBas.graphic = ImageView(Image(FileInputStream("images/pickominos/picko${plateau.totDes}.png")))
            plateau3j.pilePickoBas.graphic = ImageView(Image(FileInputStream("images/pickominos/picko${plateau.totDes}.png")))
            plateau4j.pilePickoBas.graphic = ImageView(Image(FileInputStream("images/pickominos/picko${plateau.totDes}.png")))
